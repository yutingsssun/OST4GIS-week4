...
_.forEach(bakedGoods, function(bakery){ console.log(bakery.name)});
_.map(bakedGoods, function(bakery){ console.log(bakery.name)});
// map: transform
// reduce: e.g. sum all the numbers
...
var query5 = _.filter(bakedGoods, function(bakery){return  bakery.price> 4});
...
var query6 = _.sortBy(bakedGoods, function(bakery){return bakery.inventory;});

console.log('Sorted by inventory (lowest to highest):', query6);
console.log('Sorted by inventory (highest to lowest):', query6.reverse());

/* =====================
Use _.groupBy to organize the baked goods by type.
===================== */

var query7 = _.groupBy(bakedGoods, function(bakery){return bakery.type});
